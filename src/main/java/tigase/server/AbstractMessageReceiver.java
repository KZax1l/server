...
public abstract class AbstractMessageReceiver
     ...
     * external components.
     *
     * @param address is a Java regular expression string for the packet's destination
     ...
     *
     * @param packet is a <code>Packet</code> which needs to be processed by some
     *               thread.
     ...
     *
     * @param packet is an output packet which normally has to go to other component
     ...
     *
     * @param packet is an instance of the <code>Packet</code> class passed for
     *               processing.
     */
